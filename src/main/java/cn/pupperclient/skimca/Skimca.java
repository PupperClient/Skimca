...
import cn.pupperclient.skimca.image.ImageHelper;
...
public class Skimca {
    ...
    /**
     * Automatically discovers and registers all classes in the current
     * classpath that contain {@code @EventTarget} annotated methods.
     * This method should be called during mod initialization.
     */
    public static void autoRegisterEventHandlers() {
        ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        SkimcaEventManager.getInstance().autoRegisterFromClassLoader(classLoader);
    }

    /**
     * Registers a specific class containing {@code @EventTarget} methods.
     * The class must have a public no-argument constructor.
     *
     * @param handlerClass the class to register
     */
    public static void registerEventHandler(Class<?> handlerClass) {
        SkimcaEventManager.getInstance().register(handlerClass);
    }

    /**
     * Registers an object containing {@code @EventTarget} methods.
     *
     * @param handler the object to register
     */
    public static void registerEventHandler(Object handler) {
        SkimcaEventManager.getInstance().register(handler);
    }
